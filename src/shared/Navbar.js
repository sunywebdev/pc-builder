				...
				<div
					...
					<div className='hidden lg:flex justify-end items-center'>
						{session?.user.email ? (
							<button
								onClick={() => signOut()}
								className='-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-purple-700 hover:bg-gray-50'>
				...
				<div className='mx-auto flex max-w-7xl items-center justify-between pb-3 '>
					...
					<div>
						<Link href={"/pc_builder"}>
							<button className='hidden lg:block px-6 py-3 bg-purple-700 rounded-md text-white font-bold'>
								PC Builder
							</button>
						</Link>
					</div>
